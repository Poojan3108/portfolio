          ...
          <div className="space-y-6">
            ...
            <div className={cn(
              ...
              <Button asChild variant="default" size="lg" className="rounded-full shadow-md">
                <Link href="mailto:poojan31.brahmbhatt@gmail.com">
            ...
            <div className={cn(
              ...
              <Link href="https://github.com/Poojan3108/Resume/blob/main/POOJAN%20BRAHMBHATT%20RESUME.pdf" target="_blank" className="text-xs text-muted-foreground hover:text-foreground transition-colors">
                Resume
              </Link>
            </div>
          </div>
